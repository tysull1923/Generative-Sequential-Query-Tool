		...
		<div className="flex items-center space-x-4">
			...
			<div className="flex items-center space-x-6">
				<div className="flex items-center">
					<div className={`h-2 w-2 rounded-full mr-2 ${apiStatus.openai === 'operational' ? 'bg-green-500' :
							apiStatus.openai === 'checking' ? 'bg-yellow-500' : 'bg-red-500'
						}`} />
					<span className="text-sm">OpenAI</span>
				</div>
				<div className="flex items-center">
					<div className={`h-2 w-2 rounded-full mr-2 ${apiStatus.claude === 'operational' ? 'bg-green-500' :
